...
public class AddNameTest {
    ...
    @Test
    public void main() {
        String[] emaillist={"@163.com","@hotmail.com","@gmail.com","@qq.com","@outlook.com","@mail.dhu.edu.cn"};
        ...
        for (int i = 0; i < 50; i++) {
            ...
            for(int j=1;j<=5;++j){
                Integer t=(Integer)(random.nextInt(10));
                email=email+t.toString();
            }
            a = (int) Math.abs(emaillist.length * Math.random());
            email=email+emaillist[a];
            System.out.println(email);
            String password="";
            for(int j=1;j<=8;++j){
                Integer t=(Integer)(random.nextInt(10));
                password=password+t.toString();
            }
            ...
            String avatar="/static/images/avatars/avatar.jpeg";
            Double money=200.0;
